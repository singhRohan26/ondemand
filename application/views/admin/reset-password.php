    ...
    <body class=" login_page">
        <div class="login-wrapper">
            <div id="login" class="login loginpage col-lg-offset-4 col-lg-4 col-md-offset-3 col-md-6 col-sm-offset-3 col-sm-6 col-xs-offset-0 col-xs-12">
                <h1><a href="#" title="Reset Password Page" tabindex="-1">Ultra Admin</a></h1>
                <form name="resetPassword" id="resetPassword" action="<?php if(!empty($admin_id)){ echo base_url('admin/do-reset-passowrd/'.$admin_id); } else { echo "#"; } ?>" method="post">
                    ...
                    <p>
                        <label for="confrim_password">Confirm Password<br />
                            <input type="password" name="confrim_password" id="confrim_password" class="input" value="" size="20" /></label>
                    </p>
                    <p class="submit">
