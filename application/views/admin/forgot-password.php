...
<head>
        ...
        <meta charset="utf-8" />
        <title>On-Demand: <?php if(!empty($title)) { echo $title; } ?></title>
    ...
    <body class=" login_page">
        <div class="login-wrapper">
            <div id="login" class="login loginpage col-lg-offset-4 col-lg-4 col-md-offset-3 col-md-6 col-sm-offset-3 col-sm-6 col-xs-offset-0 col-xs-12">
                <h1><a href="#" title="Forgot Password Page" tabindex="-1">Ultra Admin</a></h1>
                                <div class="head" style="font-size: 33px;">Recover your password </div>


                <form name="verifyEmailForm" id="loginform" action="<?php echo base_url('admin/check-emailid');?>" method="post">
                    <div id="error_msg"></div>
                    <p>
                        <label for="emailid">Enter Registered Email Id<br/>
                            <input type="email" name="emailid" id="emailid" class="input" value="" size="20" /></label>
                    </p>
                    <p class="submit">
                        <input type="submit" name="wp-submit" id="wp-submit" class="btn btn-orange btn-block" value="Send Link" />
                    </p>
                </form>

                <p id="nav">
                    <a class="pull-left" href="<?php echo base_url('admin/login');?>" title="Admin Login">Login</a>
                </p>
            </div>
        </div>
